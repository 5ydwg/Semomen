                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Text('세상의 모든 멘토', style: TextStyle(color: Colors.white, fontSize: 24.0, fontWeight: FontWeight.bold),),
                        ],
                      ),
                      Text(
                        '진로 고민\n해결 가이드',
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            GestureDetector(
                                ...
                                child: isObscure?Icon(Icons.visibility_off_outlined, color: Colors.grey,):Icon(Icons.remove_red_eye_outlined, color: Colors.grey,)
                            ),
                          ],
                        ),
                        Divider(),
                        ...
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                            Text('비밀번호를 잊어버리셨나요?', style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold),),
                            Text(' 비밀번호 재설정', style: TextStyle(color: mainBlueGrotto, fontWeight: FontWeight.bold),),
                          ],
                        ),
                        SizedBox(height: 16.0,),
                        SizedBox(
